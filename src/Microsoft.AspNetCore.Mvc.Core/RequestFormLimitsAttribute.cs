...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public class RequestFormLimitsAttribute : Attribute, IFilterFactory, IOrderedFilter
    {
        ...
        public bool BufferBody
        {
            get
            {
                return _formOptions.BufferBody;
            }
            set
            {
                _formOptions.BufferBody = value;
            }
        }
        ...
        public int MemoryBufferThreshold
        {
            get
            {
                return _formOptions.MemoryBufferThreshold;
            }
            set
            {
                _formOptions.MemoryBufferThreshold = value;
            }
        }
        ...
        public long BufferBodyLengthLimit
        {
            get
            {
                return _formOptions.BufferBodyLengthLimit;
            }
            set
            {
                _formOptions.BufferBodyLengthLimit = value;
            }
        }
        ...
        public int ValueCountLimit
        {
            get
            {
                return _formOptions.ValueCountLimit;
            }
            set
            {
                _formOptions.ValueCountLimit = value;
            }
        }
        ...
        public int KeyLengthLimit
        {
            get
            {
                return _formOptions.KeyLengthLimit;
            }
            set
            {
                _formOptions.KeyLengthLimit = value;
            }
        }
        ...
        public int ValueLengthLimit
        {
            get
            {
                return _formOptions.ValueLengthLimit;
            }
            set
            {
                _formOptions.ValueLengthLimit = value;
            }
        }
        ...
        public int MultipartBoundaryLengthLimit
        {
            get
            {
                return _formOptions.MultipartBoundaryLengthLimit;
            }
            set
            {
                _formOptions.MultipartBoundaryLengthLimit = value;
            }
        }
        ...
        public int MultipartHeadersCountLimit
        {
            get
            {
                return _formOptions.MultipartHeadersCountLimit;
            }
            set
            {
                _formOptions.MultipartHeadersCountLimit = value;
            }
        }
        ...
        public int MultipartHeadersLengthLimit
        {
            get
            {
                return _formOptions.MultipartHeadersLengthLimit;
            }
            set
            {
                _formOptions.MultipartHeadersLengthLimit = value;
            }
        }
        ...
        public long MultipartBodyLengthLimit
        {
            get
            {
                return _formOptions.MultipartBodyLengthLimit;
            }
            set
            {
                _formOptions.MultipartBodyLengthLimit = value;
            }
        }
        ...
        public IFilterMetadata CreateInstance(IServiceProvider serviceProvider)
        {
            ...
            filter.FormOptions = _formOptions;
            return filter;
        }
    }
}
